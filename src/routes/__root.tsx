  ...
  head: () => ({
    meta: [
      ...
      { title: "Yaris A. Nadaf — Backend, Full Stack, AI/ML & IoT Engineer" },
      {
        name: "description",
        content:
          "Portfolio of Yaris A. Nadaf — backend engineer, full stack developer, AI/ML developer and IoT builder.",
      },
      { name: "author", content: "Yaris A. Nadaf" },
      { property: "og:title", content: "Yaris A. Nadaf — Engineer" },
      { property: "og:description", content: "Backend · Full Stack · AI/ML · IoT" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Yaris A. Nadaf" },
